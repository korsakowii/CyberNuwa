(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    3046: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 6275));
    },
    6275: function (e, t, s) {
      'use strict';
      (s.r(t),
      ...
      function l() {
        let [e, t] = (0, i.useState)('zh'),
          ...
          r = {
            zh: {
              ...
              overview: '平台概览',
              overviewDesc:
                'CyberNuwa是一个开放的AI智能体共创平台，集成了任务发布、智能体训练和社区协作。',
              explore: '探索平台模块',
              backToMain: '返回主站',
              totalModules: '核心模块',
              totalViews: '总访问量',
          ...
          o = c.reduce((e, t) => e + t.views, 0),
          d = c.filter(e => 'active' === e.status).length,
          x = c.filter(e => 'beta' === e.status).length;
        (0, i.useEffect)(() => {
          let e = parseInt(localStorage.getItem('showcase-views') || '0') + 1;
          (localStorage.setItem('showcase-views', e.toString()), l(e));
        }, []);
        let u = e => {
          ...
          h = t => {
            let s = {
              active: { color: 'bg-green-500', text: r[e].status.active },
              beta: { color: 'bg-yellow-500', text: r[e].status.beta },
              'coming-soon': {
                color: 'bg-gray-500',
                text: r[e].status['coming-soon'],
              },
            }[t];
            return (0, a.jsx)('span', {
              className:
                'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-white '.concat(
                  s.color
                ),
              children: s.text,
            });
        ...
        return (0, a.jsxs)('div', {
          ...
          children: [
            ...
            (0, a.jsx)('section', {
              className: 'py-16 bg-gradient-to-br from-blue-900 to-purple-900',
              children: (0, a.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, a.jsx)('p', {
                    ...
                    children: r[e].overviewDesc,
                  }),
                  (0, a.jsxs)(n.default, {
                    href: 'https://cyber-nuwa.vercel.app/',
                    className:
                      'inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors',
                    children: [
                      r[e].backToMain,
                      (0, a.jsx)('span', { className: 'ml-2', children: '→' }),
                    ],
                  }),
                ],
              }),
                  ...
                  (0, a.jsx)('div', {
                    ...
                    children: c.map(t =>
                      (0, a.jsxs)(
                        ...
                        {
                          className:
                            'bg-zinc-800 rounded-lg p-6 border border-zinc-700 hover:border-blue-500 transition-colors',
                          children: [
                            (0, a.jsxs)('div', {
                              className:
                            ...
                            (0, a.jsxs)('div', {
                              ...
                              children: [
                                (0, a.jsxs)('div', {
                                  className:
                                    'flex justify-between text-sm text-zinc-500 mb-1',
                                  children: [
                                    (0, a.jsx)('span', {
                                      children: r[e].views,
                                    }),
                            ...
                            (0, a.jsxs)('div', {
                              ...
                              children: [
                                (0, a.jsxs)('div', {
                                  ...
                                  children: [r[e].features, ':'],
                                }),
                                (0, a.jsx)('div', {
                                  className: 'flex flex-wrap gap-1',
                                  children: t.features.slice(0, 2).map((t, s) =>
                                    (0, a.jsx)(
                                      'span',
                                      {
                                        className:
                                          'px-2 py-1 bg-zinc-700 rounded text-xs',
                                        children: t[e],
                                      },
                                      s
                                    )
            ...
            (0, a.jsx)('footer', {
              className: 'bg-zinc-800 border-t border-zinc-700 py-8',
              children: (0, a.jsx)('div', {
                className: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center',
                children: (0, a.jsxs)('p', {
                  className: 'text-zinc-400',
                  children: ['\xa9 2024 CyberNuwa. ', r[e].subtitle],
                }),
              }),
            }),
          ],
