(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    4286: function (e, t, i) {
      Promise.resolve().then(i.bind(i, 8897));
    },
    8897: function (e, t, i) {
      'use strict';
      (i.r(t),
          ...
          o = [
            {
              ...
              title: {
                zh: 'AI 写作助手开发',
                en: 'AI Writing Assistant Development',
              },
              description: {
            ...
            },
            {
              ...
              title: {
                zh: '多语言翻译工具',
                en: 'Multilingual Translation Tool',
              },
              description: {
              ...
              children: [
                (0, s.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, s.jsx)(n.default, {
                      href: '/launch-mission',
                      className:
                        'inline-block bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105',
                      children: i.addTask,
                    }),
                  ],
                }),
                (0, s.jsxs)('div', {
                  ...
                  children: [
                    (0, s.jsxs)('div', {
                      className:
                        'bg-zinc-800/50 border border-zinc-700 rounded-xl p-6 text-center',
                      children: [
                        (0, s.jsx)('div', {
                    ...
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsx)('div', {
                          ...
                          children: o.filter(e => 'in-progress' === e.status)
                            .length,
                        }),
                        (0, s.jsx)('div', {
                          className: 'text-zinc-400',
                          children: i.inProgress,
                        }),
                      ],
                    }),
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsx)('div', {
                          ...
                          children: o.filter(e => 'completed' === e.status)
                            .length,
                        }),
                        (0, s.jsx)('div', {
                          className: 'text-zinc-400',
                    ...
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsx)('div', {
                          ...
                          children: o.reduce((e, t) => e + t.participants, 0),
                        }),
                        (0, s.jsx)('div', {
                          className: 'text-zinc-400',
                ...
                (0, s.jsx)('div', {
                  ...
                  children: o.map(t => {
                    ...
                    return (0, s.jsx)(
                      ...
                      {
                        className:
                          'bg-zinc-800/50 backdrop-blur-sm border border-zinc-700 rounded-xl p-6 hover:bg-zinc-800/70 hover:border-zinc-600 transition-all duration-300',
                        children: (0, s.jsxs)('div', {
                          ...
                          children: [
                            (0, s.jsxs)('div', {
                              ...
                              children: [
                                ...
                                'in-progress' === t.status &&
                                  (0, s.jsxs)('div', {
                                    ...
                                    children: [
                                      ...
                                      (0, s.jsx)('div', {
                                        className:
                                          'w-full bg-zinc-700 rounded-full h-2',
                                ...
                                (0, s.jsxs)('div', {
                                  ...
                                  children: [
                                    (0, s.jsxs)('span', {
                                      children: [i.deadline, ' ', t.deadline],
                                    }),
                                    (0, s.jsxs)('span', {
                                      children: [
                                        i.participants,
                            ...
                            (0, s.jsxs)('div', {
                              className:
                                'flex flex-col space-y-2 min-w-[120px]',
                              children: [
                                'open' === t.status
                                  ? (0, s.jsx)('button', {
                                      className:
                                  ...
                                  : 'in-progress' === t.status
                                    ? (0, s.jsx)('button', {
                                        className:
                                          'w-full bg-yellow-600 hover:bg-yellow-700 text-white font-medium py-2 px-4 rounded-lg transition-colors',
                                        children: i.viewProgress,
                                      })
                                    : (0, s.jsx)('button', {
                                        className:
                                          'w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition-colors',
                                        children: i.viewResult,
                                      }),
                                (0, s.jsx)('button', {
                                  className:
                                    'w-full bg-zinc-700 hover:bg-zinc-600 text-white font-medium py-2 px-4 rounded-lg transition-colors',
                                  children: i.details,
                                }),
                              ],
                            }),
                  ...
                  (0, s.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, s.jsx)(n.default, {
                        href: '/launch-mission',
                        className:
                          'inline-block bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300',
                        children: i.launchFirstTask,
                      }),
                    ],
                  }),
              ],
