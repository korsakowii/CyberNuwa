(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    4177: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 5732));
    },
    5732: function (e, t, s) {
      'use strict';
      (s.r(t),
        ...
        let { language: e, setLanguage: t } = (0, a.Z)(),
          ...
          [l, c] = (0, n.useState)([
            ...
            },
            {
              ...
              title: {
                zh: '多语言翻译助手',
                en: 'Multilingual Translation Assistant',
              },
              description: {
                ...
                (0, i.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, i.jsx)('button', {
                      onClick: () => h(!m),
                      className:
                        'inline-block bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105',
                      children: s.addWish,
                    }),
                  ],
                }),
                          ...
                          (0, i.jsxs)('div', {
                            children: [
                              ...
                              (0, i.jsx)('input', {
                                ...
                                required: !0,
                                className:
                                  'w-full px-4 py-3 bg-zinc-700/50 border border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent text-white placeholder-zinc-400',
                                placeholder:
                                  'zh' === e
                                    ? '给你的愿望起个名字...'
                                    : 'Give your wish a name...',
                              }),
                            ],
                          }),
                          (0, i.jsxs)('div', {
                            children: [
                              ...
                              (0, i.jsx)('textarea', {
                                id: 'description',
                                value: u.description[e],
                                onChange: p,
                                name: 'description',
                                required: !0,
                                rows: 4,
                                className:
                                  'w-full px-4 py-3 bg-zinc-700/50 border border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent text-white placeholder-zinc-400 resize-none',
                                placeholder:
                                  'zh' === e
                                    ? '详细描述你的愿望，让其他人理解你的想法...'
                                    : 'Describe your wish in detail so others can understand your idea...',
                              }),
                            ],
                          }),
                          (0, i.jsxs)('div', {
                            children: [
                              ...
                              (0, i.jsx)('input', {
                                ...
                                placeholder:
                                  'zh' === e
                                    ? '用逗号分隔，如：AI, 创意, 工具'
                                    : 'Separate with commas, e.g.: AI, Creativity, Tools',
                              }),
                            ],
                          }),
                          (0, i.jsxs)('div', {
                            ...
                            children: [
                              (0, i.jsx)('button', {
                                type: 'submit',
                                className:
                                  'flex-1 bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors',
                                children: 'zh' === e ? '许愿' : 'Make Wish',
                              }),
                              (0, i.jsx)('button', {
                                type: 'button',
                                onClick: () => h(!1),
                                className:
                                  'flex-1 bg-zinc-700 hover:bg-zinc-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors',
                                children: 'zh' === e ? '取消' : 'Cancel',
                              }),
                            ],
                          }),
                        ],
                      ...
                      'div',
                      {
                        ...
                        children: [
                          ...
                          (0, i.jsx)('div', {
                            ...
                            children: t.tags[e].map((e, t) =>
                              (0, i.jsx)(
                                'span',
                                {
                                  className:
                                    'px-2 py-1 bg-zinc-700/50 text-zinc-300 text-xs rounded-full',
                                  children: e,
                                },
                                t
                              )
                          ...
                          (0, i.jsxs)('div', {
                            className:
                              'flex items-center justify-between text-sm text-zinc-400',
                            children: [
                              (0, i.jsxs)('div', {
                                ...
                                children: [
                                  (0, i.jsxs)('button', {
                                    className:
                                      'flex items-center space-x-1 hover:text-pink-400 transition-colors',
                                    children: [
                                      (0, i.jsx)('span', { children: '❤️' }),
                                      (0, i.jsx)('span', { children: t.likes }),
                                    ],
                                  }),
                                  (0, i.jsxs)('button', {
                                    className:
                  ...
                  (0, i.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, i.jsx)('h3', {
                        className: 'text-xl font-semibold mb-2',
                        children:
                          'zh' === e ? '许愿池还是空的' : 'Wish Pool is Empty',
                      }),
                      (0, i.jsx)('p', {
                        className: 'text-zinc-400 mb-6',
                        children:
                      ...
                      (0, i.jsx)('button', {
                        onClick: () => h(!0),
                        className:
                          'inline-block bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300',
                        children:
                          'zh' === e ? '许下第一个愿望' : 'Make the First Wish',
                      }),
                    ],
                  }),
              ],
