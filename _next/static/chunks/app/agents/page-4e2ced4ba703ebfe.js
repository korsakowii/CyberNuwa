(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    5435: function (e, t, i) {
      Promise.resolve().then(i.bind(i, 7335));
    },
    7335: function (e, t, i) {
      'use strict';
      (i.r(t),
                ...
                (0, s.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, s.jsx)(n.default, {
                      href: '/train-agent',
                      className:
                        'inline-block bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105',
                      children: i.trainNew,
                    }),
                  ],
                }),
                    ...
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsx)('div', {
                          ...
                          children: o.filter(e => 'active' === e.status).length,
                        }),
                        (0, s.jsx)('div', {
                          className: 'text-zinc-400',
                          children: i.stats.active,
                        }),
                      ],
                    }),
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsx)('div', {
                          ...
                          children: o.filter(e => 'training' === e.status)
                            .length,
                        }),
                        (0, s.jsx)('div', {
                          className: 'text-zinc-400',
                          children: i.stats.training,
                        }),
                      ],
                    }),
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsxs)('div', {
                          ...
                          children: [
                            Math.round(
                              o.reduce((e, t) => e + t.trainingProgress, 0) /
                                o.length
                            ),
                            '%',
                          ],
                        ...
                        (0, s.jsx)('div', {
                          className: 'text-zinc-400',
                          children: 'zh' === e ? '平均完成度' : 'Avg Progress',
                        }),
                      ],
                    }),
                  ],
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              (0, s.jsx)('div', {
                                ...
                                children: (0, s.jsx)('div', {
                                  ...
                                  style: {
                                    width: ''.concat(t.trainingProgress, '%'),
                                  },
                                }),
                              }),
                            ],
                          ...
                          (0, s.jsxs)('div', {
                            ...
                            children: [
                              (0, s.jsx)('button', {
                                className:
                                  'flex-1 bg-zinc-700 hover:bg-zinc-600 text-white text-sm py-2 px-3 rounded-lg transition-colors',
                                children:
                                  'zh' === e ? '查看详情' : 'View Details',
                              }),
                              (0, s.jsx)('button', {
                                className:
                                  'flex-1 bg-blue-600 hover:bg-blue-700 text-white text-sm py-2 px-3 rounded-lg transition-colors',
                                children: 'zh' === e ? '使用' : 'Use',
                              }),
                            ],
                          }),
                        ],
                  ...
                  (0, s.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, s.jsx)('h3', {
                        ...
                        children: 'zh' === e ? '还没有智能体' : 'No agents yet',
                      }),
                      (0, s.jsx)('p', {
                        className: 'text-zinc-400 mb-6',
                        children:
                          'zh' === e
                            ? '成为第一个训练智能体的用户吧！'
                            : 'Be the first to train an agent!',
                      }),
                      (0, s.jsx)(n.default, {
                        href: '/train-agent',
                        className:
                          'inline-block bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300',
                        children: 'zh' === e ? '开始训练' : 'Start Training',
                      }),
                    ],
                  }),
              ],
