(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    2854: function (e, n, t) {
      (Promise.resolve().then(t.bind(t, 8596)),
        Promise.resolve().then(t.t.bind(t, 4742, 23)),
        Promise.resolve().then(t.t.bind(t, 7960, 23)));
    },
    8596: function (e, n, t) {
      'use strict';
      t.d(n, {
      ...
      function i(e) {
        ...
        return (0, r.jsx)(u.Provider, {
          value: { language: t, setLanguage: i },
          children: n,
        });
      }
      function c() {
  ...
  function (e) {
    (e.O(0, [540, 971, 117, 744], function () {
      return e((e.s = 2854));
    }),
      (_N_E = e.O()));
  },
