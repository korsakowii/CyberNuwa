#!/usr/bin/env python3
"""
Exquisite Nuwa Model Creator
创建一个精致的女娲3D模型，包含高级材质、精细细节和专业渲染设置
"""
...
back_light.data.energy = 4.0
back_light.data.color = (1.0, 1.0, 0.9)  # 暖色调

# 顶部光 - 区域光
bpy.ops.object.light_add(type='AREA', location=(0, 0, 8))
top_light = bpy.context.active_object
top_light.data.energy = 2.0
top_light.data.size = 4.0
top_light.data.color = (1.0, 1.0, 1.0)  # 中性色调

# 侧光 - 区域光
bpy.ops.object.light_add(type='AREA', location=(4, -2, 2))
side_light = bpy.context.active_object
side_light.data.energy = 2.5
side_light.data.size = 2.0
side_light.data.color = (0.95, 0.9, 1.0)  # 紫色调
