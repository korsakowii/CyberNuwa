...
export default function ParticleButton({
  ...
  // 这个函数被注释掉了，因为我们现在使用 animateParticlesWithCanvas
  ...
  const animateParticlesWithCanvas = (
    particles: Particle[],
    ...
    if (particles.length > 0) {
      animationRef.current = requestAnimationFrame(() =>
        animateParticlesWithCanvas(particles, targetCanvas)
      );
    } else {
